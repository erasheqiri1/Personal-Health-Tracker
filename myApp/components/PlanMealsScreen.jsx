// //perdoret te plans humb pesh shto pesh mbaj pesh
...
// import { auth, db } from '../firebaseConfig'; // 🟡 RREGULLO PATH sipas strukturës (../ ose ../../)
...
//       Alert.alert(
//         'Ruajtur',
//         `U ruajt për sot: ${totalKcal} kcal (${headerTitle}).`
//       );
//     } catch (e) {

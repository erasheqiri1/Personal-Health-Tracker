// // // //perdoret te homeworkout edhe weightlifting
...
// // // import { db } from '../firebaseConfig'; // ⚠️ rregullo ../ ose ../../ varësisht ku e ke components folderin
...
// // //   // Leximi i ushtrimeve për këtë plan (homeworkout / weightlifting)
// // //   useEffect(() => {
// // //     setLoading(true);
// // //     const q = query(
...
// // //   // Lexo totalin e kalorive për sot
// // //   useEffect(() => {
// // //     const loadTotal = async () => {
// // //       const today = new Date().toISOString().slice(0, 10);
// // //       const key = `workout_kcal_${today}`; // e njëjta për të dy planet → totali ditor
...
// // //                   <MaterialCommunityIcons
// // //                     name={item.icon} // merret prej Firestore, admini e cakton ikonën
// // //                     size={44}
// // //                     color={COLORS.green}
// // //                   />
// // //                 </View>
...
// // import { auth, db } from '../firebaseConfig'; // ⚠️ sigurohu që ke export auth + db
...
// //   // Lexo totalin e kalorive për sot nga Firestore (nëse ka user), përndryshe nga AsyncStorage
// //   useEffect(() => {
// //     const loadTotal = async () => {
// //       const today = new Date().toISOString().slice(0, 10);
...
// //       // Nëse s’ka user, përdor vetëm AsyncStorage
// //       if (!user) {
...
// //     try {
// //       // 1) Update lokalisht (AsyncStorage)
...
// //       // 2) Ruaj edhe në Firestore nëse ka user të loguar
// //       if (user) {
// //         const docRef = doc(db, 'workoutDaily', `${user.uid}_${today}`);
// //         await setDoc(
// //           docRef,
...
// //             userId: user.uid,
// //             date: today,
// //             plan: planKey, // mundesh me e përdor më vonë për statistikë per plan
...
//   // Lexo totalin e kalorive për sot nga Firestore (user i LOGUAR) + sync me AsyncStorage
//   useEffect(() => {
//     const loadTotal = async () => {
//       const user = auth.currentUser;

//       if (!user) {
//         console.log('No user in WorkoutPlanScreen – nuk duhet me ndodh.');
//         setTotalCalories(0);
//         return;
//       }
...
//   // Llogaritja dhe ruajtja e kalorive
//   const calcCalories = async () => {
//     const user = auth.currentUser;
...
//   where,
// } from 'firebase/firestore';
// import { db } from '../firebaseConfig'; // ⚠️ sigurohu që ke export db
// import { useAuth } from '../context/AuthContext'; // ⚠️ RREGULLO PATH sipas projektit
...
//   const { user, loading: authLoading } = useAuth(); // ⬅️ user nga AuthContext
...
//   // Lexo totalin e kalorive për sot nga Firestore (user i LOGUAR) + sync me AsyncStorage
//   useEffect(() => {
//     if (authLoading) return;    // prit derisa AuthContext me u bo gati
//     if (!user) return;          // nëse s’ka user, mos prek AsyncStorage / state
